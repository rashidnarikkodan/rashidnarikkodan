...
* 🧠 Focused on **API design, data flow, and scalable architecture**
* 🔐 Working on **secure authentication systems (JWT, protected routes)**
* 📊 Improving **database performance (indexing, efficient queries)**
* 🌱 Learning **DSA (trees, graphs, recursion, problem-solving)**
